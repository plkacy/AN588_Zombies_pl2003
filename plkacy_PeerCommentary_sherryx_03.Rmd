...
[***\^\^CHANGED TO HEADER 2 SO IT LOOKS MORE ORGANIZED IN THE TABLE OF CONTENT***]{.underline}

Numeric variables are height, weight, age, zombies killed, and years of education

[***I LIKE HOW YOU WROTE OUT EACH PART OF THE GGPLOT FUNCTION. I GROUPED MINE TOGETHER LIKE THIS***]{.underline}
...
[***\^\^ I ALSO SAID THIS!! AWESOME JOB!!***]{.underline}
...
[***I LIKE HOW YOU PUT YOU HISTOGRAMS ALL TOGETHER AND THE QQPLOTS ALL TOGETHER. I DID PAR TO BEGIN WITH AND COMPARE PER SET LIKE THIS: BUT ITS COOL TO SEE HOW BOTH WAYS WORK! NICE JOB***]{.underline}

normal_distribution_check \<- function(variable, name) { par(mfrow = c(1, 2)) \# Side-by-side plots histogram vs pplot comparision hist(variable, main = paste("Histogram of", name), col = "lightblue", probability = TRUE) #histogram view qqnorm(variable, main = paste("Q-Q Plot of", name)) #qqplot view qqline(variable, col = "red") #qqplot linear diagonal line }
...
[***\^\^I ALSO SAID THE SAME. BUT LETS DIG DEEPER AND THINK THAT IF THEY ARE NOT NORMALLY DISTRIBUTED, WHAT TYPE OF DISTRIBUTION CAN THEY BE? MAYBE POSSION DISTRIBUTION IF IT IS SKEWED TO THE LEFT?***]{.underline}
...
[***THIS LOOKS SUPER CLEAN AND EASY TO FOLLOW. MY ONLY SUGGESTION IS CAN YOU EXPLAIN IN YOUR COMMENT IS THE LOWER AND UPPER BOUNDS OF THE CI. CAN YOU EXPLAIN FOR EXAMPLE WHY YOU USED 1.96? OVERALL IT LOOKS AWESOME!!!***]{.underline}
...
[***CODING ALL THE TASKS IN ONE CHUCNK IS A BIT HARD TO FOLLOW SINCE THERES SO MUCH GOING ON FOR THIS PROBLEM. I SUGGEST BREAKING UP THE CODE CHUNCKS TO SAMPING FIRST. THEN FIGURING OUT SD. THEN GRAPHING***]{.underline}

[***MAKE SURE TO ALSO ANSWER THE QUESTIONS FROM THE PROBLEM. USING YOUR ORGANIZED AND VISUALLY CLEAR GRAPH: What do these sampling distributions look like (a graph might help here)? Are they normally distributed? What about for those variables that you concluded were not originally drawn from a normal distribution?***]{.underline}
